    ...
    return (
      <div className="m-3 bg-slate-100  border-2 border-gray-400 rounded-sm">
        <div className="flex">
          ...
          <div className="  text-[60px]  font-palanquin text-gray-600 pb-6 font-bold ml-72">
            <p>DVST Report</p>
          </div>
        </div>
        <div className="flex flex-col m-4 p-2 text-gray-700 text-md border-2 border-dashed border-gray-400  border-spacing-7 min-h-36"></div>
      </div>
    );
  }
  return (
